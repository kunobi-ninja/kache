...
The chart supplies a Deployment, Service, probes, optional persistent volume, optional existing-secret authentication, and optional Lease-based leader election, and an optional Ingress.
...
The Ingress does not add authentication. Set `auth.existingSecret` before you expose the service beyond a trusted network.
