...
Timeline schema 3 records the session, plan, candidate source, and zero-based
...
Upgrade the service before sending schema 3 records. The updated service also
accepts schemas 1 and 2. Wrapper events before schema 20 have no demand
